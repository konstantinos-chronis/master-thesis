...
%Read discussion in /to read/Validity threats/BTH2012ChandraManyam


%We say that construct validity can start to be established when both convergent and divergent validity are established because construct validity is something that is built over time. No single study can establish construct validity 

%http://dissertation.laerd.com/convergent-and-divergent-validity-p2.php

%Make sure to explain it in the case study
In order to avoid mono-method bias some employees were asked to fill in the surveys first so as to detect any possible issues with them. All the subjects were promised to remain anonymous, resulting in mitigating the evaluation apprehension \cite{wohlin2012expse}.

%small sample is a great problem in verifying convergent validity
