...
In order to examine how \ac{OPS}, \ac{PAM} and \ac{TAA} correlate when measuring the agility of software development teams, four teams in company A were used as a sample. In the next pages is presented information on its teams, products and the agile practices used.
...
\section{Reasons for correlations}
