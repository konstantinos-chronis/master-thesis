...
\lettrine[lines=4, loversize=-0.1, lraise=0.1]{T}{his} chapter presents the research questions and the methodology followed while conducting this Master's Thesis. 
...
The creators of \ac{PAM}, \ac{TAA} and \ac{OPS} state that their tool measures agility. Their existence though implies that each one is more appropriate than the others in doing so. The purpose of this study is to validate whether these tools actually do measure agility or not. 
...
For the needs of this study, four teams in company A were used as a sample. In the next pages we present information on the company's teams, products and the agile practices used.
