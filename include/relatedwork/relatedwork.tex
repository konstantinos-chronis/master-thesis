...
\todo{You need to consistently speak of the idea of convergent validity in connection to what you are doing. } In the next chapter follow the research questions and the research methodology which was performed in order to validate \ac{PAM}, \ac{TAA} and \ac{OPS}.