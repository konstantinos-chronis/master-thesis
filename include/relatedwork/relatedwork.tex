...
The measurement of the degree of agility in this level is done based on five variables. %Table~\ref{fig:dimension2} provides a description for them.
%\begin{inparaenum} [a\upshape)]
%\item Flexibility
%\item Speed
%\item Leanness
...
Each of these aspects is followed by a number of questions rated in six-point Likert scale and the results are represented in a radar chart.
