...
\paragraph{Results:} 
The correlations of the data gathered were very few and very low. As a result, convergent validity could not be established. In addition, the questions which were identified as the same among the tools did not have the same answers from the respondents. Moreover, \ac{OPS} was the tool covering the most agile practices. All the above provide evidence that the three tools do not measure agility in the same way.
