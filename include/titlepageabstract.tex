...
\paragraph{Objective:} 
Many tools have been created for measuring the agility of software development teams, creating a saturation in the field. Three tools were selected in order to validate whether they will yield similar results. These tools were Perceptive Agile Measurement (PAM), Team Agility Assessment (TAA) and Objectives Principles Strategies (OPS).
